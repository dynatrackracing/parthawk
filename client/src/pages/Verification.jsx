...
const Verification = () => {
  ...
  return (
    <div className="w-full flex flex-wrap s-auth">
      <div className="w-full md:w-1/2 flex flex-col">
        <div className="s-auth__img flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
          ...
          <FadeIn delay={100}>
            <div className="flex items-center justify-center">
              <div>
                ...
                <p>
                  We are currently reviewing your application and will enable
      ...
      <div className="md:block w-1/2 shadow-2xl">
        <img
          className="object-cover w-full h-screen md:block"
